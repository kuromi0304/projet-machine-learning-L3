...
from sklearn.preprocessing import StandardScaler  # pour mettre les colonnes sur la même échelle
from sklearn.feature_selection import SelectKBest, f_regression  # pour sélectionner les meilleurs attributs
from sklearn.cluster import KMeans  # pour créer des groupes similaires (clusters)
=======
import numpy as np
from sklearn.preprocessing import StandardScaler
from sklearn.feature_selection import SelectKBest, f_regression
...
<<<<<<< HEAD
    Étapes :
        1. Choisir les attributs pour regrouper les films (budget, popularité, vote, revenu, score)
    ...
    cluster_attributes = [
        'budget', 'popularity',
        'vote_average', 'revenue_log', 'succes_score'
    ]

    X_cluster = df[cluster_attributes].copy()
